...
const mdRoutes: Array<{ path: string; mdFile: string }> = [
  ...
  { path: '/about/strategic-objectives', mdFile: 'about-strategic-objectives.md' },
  { path: '/about/contact', mdFile: 'about-contact.md' },
  { path: '/project/introduction', mdFile: 'project-introduction.md' },
  { path: '/project/problem-statement', mdFile: 'project-problem-statement.md' },
  { path: '/project/concept-note', mdFile: 'project-concept-note.md' },
  { path: '/methodology/literature-review', mdFile: 'methodology-literature-review.md' },
  { path: '/methodology/feasibility-study', mdFile: 'methodology-feasibility-study.md' },
  { path: '/methodology/needs-assessment', mdFile: 'methodology-needs-assessment.md' },
  { path: '/methodology/stakeholder-analysis', mdFile: 'methodology-stakeholder-analysis.md' },
  { path: '/methodology/data-collection', mdFile: 'methodology-data-collection.md' },
  { path: '/implementation/phases', mdFile: 'implementation-phases.md' },
  { path: '/implementation/key-activities', mdFile: 'implementation-key-activities.md' },
  { path: '/implementation/deliverables', mdFile: 'implementation-deliverables.md' },
  { path: '/products/financial-products', mdFile: 'products-financial-products.md' },
  { path: '/products/value-proposition', mdFile: 'products-value-proposition.md' },
  { path: '/products/customer-segments', mdFile: 'products-customer-segments.md' },
